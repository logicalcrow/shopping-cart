...
Run the Composer require command from the Terminal:
    ...
    composer require logicalcrow/shopping-cart
...
You definitely should publish the `config` file and take a look at it.
    ...
    php artisan vendor:publish --provider="Logicalcrow\ShoppingCart\ShoppingCartServiceProvider" --tag="config"
...
use Logicalcrow\ShoppingCart\Contracts\InstanceIdentifier;
...
The calculation logic for the package is implemented and defined in `Calculator` classes. These implement the `Logicalcrow\ShoppingCart\Contracts\Calculator` Contract and and determine how the prices are calculated and rounded. The calculators can be configured in the confugration file. This is the default calculator:
```php
<?php

namespace Logicalcrow\ShoppingCart\Calculation;

use Logicalcrow\ShoppingCart\CartItem;
use Logicalcrow\ShoppingCart\Contracts\Calculator;
