...
namespace Logicalcrow\ShoppingCart;

use Carbon\Carbon;
use Closure;
use Logicalcrow\ShoppingCart\Contracts\Buyable;
use Logicalcrow\ShoppingCart\Contracts\InstanceIdentifier;
use Logicalcrow\ShoppingCart\Exceptions\CartAlreadyStoredException;
use Logicalcrow\ShoppingCart\Exceptions\InvalidRowIDException;
use Logicalcrow\ShoppingCart\Exceptions\UnknownModelException;
...
class Cart
{
     ...
     * @param array     $options
     *
     * @return \Logicalcrow\ShoppingCart\CartItem
     */
     ...
     * Add an item to the cart.
     *
     * @param \Logicalcrow\ShoppingCart\CartItem $item          Item to add to the Cart
     * @param bool                              $keepDiscount  Keep the discount rate of the Item
     * @param bool                              $keepTax       Keep the Tax rate of the Item
     * @param bool                              $dispatchEvent
     *
     * @return \Logicalcrow\ShoppingCart\CartItem The CartItem
     */
