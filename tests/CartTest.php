...
namespace Logicalcrow\Tests\ShoppingCart;

use Carbon\Carbon;
use Logicalcrow\ShoppingCart\Calculation\GrossPrice;
use Logicalcrow\ShoppingCart\Cart;
use Logicalcrow\ShoppingCart\CartItem;
use Logicalcrow\ShoppingCart\ShoppingcartServiceProvider;
use Logicalcrow\Tests\Shoppingcart\Fixtures\BuyableProduct;
use Logicalcrow\Tests\Shoppingcart\Fixtures\BuyableProductTrait;
use Logicalcrow\Tests\Shoppingcart\Fixtures\Identifiable;
use Logicalcrow\Tests\Shoppingcart\Fixtures\ProductModel;
...
class CartTest extends TestCase
{
    ...
    {
        $this->expectException(\Logicalcrow\ShoppingCart\Exceptions\InvalidRowIDException::class);
    ...
    {
        $this->expectException(\Logicalcrow\ShoppingCart\Exceptions\UnknownModelException::class);
    ...
    {
        $this->expectException(\Logicalcrow\ShoppingCart\Exceptions\CartAlreadyStoredException::class);
     ...
     *
     * @return \Logicalcrow\ShoppingCart\Cart
     */
